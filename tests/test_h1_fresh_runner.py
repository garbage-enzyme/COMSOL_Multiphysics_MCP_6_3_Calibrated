...
from tests.integration.h1_real_physical_evidence import (
...
RUNNER = ROOT / "tests" / "integration" / "h1_real_physical_evidence.py"
...
def test_runner_import_and_dry_run_do_not_import_mph_or_start_comsol():
    import_probe = subprocess.run(
        [
            ...
            "-c",
            (
                "import sys; import tests.integration.h1_real_physical_evidence; "
