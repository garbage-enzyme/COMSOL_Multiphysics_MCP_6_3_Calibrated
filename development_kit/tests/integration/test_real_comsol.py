...
PROBES = (
    ...
    "development_kit/tests/integration/h2a_native_cancel_probe.py",
    "development_kit/tests/integration/h3c_real_properties.py",
    "development_kit/tests/integration/h3d_real_preflight.py",
    "development_kit/tests/integration/m1_periodic_mesh_audit.py",
    "development_kit/tests/integration/m2_derived_geometry.py",
    "development_kit/tests/integration/m3_incidence_config.py",
    "development_kit/tests/integration/m4_resource_admission.py",
